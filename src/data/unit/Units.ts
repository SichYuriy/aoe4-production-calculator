...
import MACEDONIAN_DYNASTY_UNITS from "./MacedonianDynastyUnits";
import GOLDEN_HORDE_UNITS from "./GoldenHordeUnits";
...
const UNITS: Map<string, Unit> = new Map<string, Unit>(Object.entries({
    VILLAGER: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.CHINESE, CivilizationsEnum.HRE,
            ...
            CivilizationsEnum.SENGOKU_DAIMYO, CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: true,
        displayOrder: 300
    },
    ARCHER: {
    ...
    HORSEMAN: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.CHINESE, CivilizationsEnum.HRE, CivilizationsEnum.ENGLAND,
            CivilizationsEnum.FRENCH, CivilizationsEnum.MONGOLS, CivilizationsEnum.RUS, CivilizationsEnum.JEANNE_D_ARC,
            CivilizationsEnum.AYYUBIDS, CivilizationsEnum.ZHU_XIS_LEGACY, CivilizationsEnum.JAPANESE, CivilizationsEnum.BYZANTINES,
            CivilizationsEnum.KNIGHTS_TEMPLAR, CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: true,
        displayOrder: 1800
    },
    LANCER: {
    ...
    CROSSBOWMAN: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.CHINESE, CivilizationsEnum.HRE, CivilizationsEnum.ENGLAND,
            ...
            CivilizationsEnum.HOUSE_OF_LANCASTER, CivilizationsEnum.TUGHLAQ_DYNASTY, CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: true,
        displayOrder: 5700
    },
    SERJEANT: {
    ...
    HANDCANNONEER: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.CHINESE, CivilizationsEnum.HRE, CivilizationsEnum.ENGLAND,
            ...
            CivilizationsEnum.TUGHLAQ_DYNASTY, CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: true,
        displayOrder: 7500
    },
    TRADER: {
        ...
        types: [],
        building: null,
        civilizations: allExcept([CivilizationsEnum.KNIGHTS_TEMPLAR, CivilizationsEnum.GOLDEN_HORDE]),
        common: true,
        displayOrder: 8400
    },
    VENETIAN_TRADER: {
    ...
    RAM: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.CHINESE, CivilizationsEnum.HRE,
            ...
            CivilizationsEnum.TUGHLAQ_DYNASTY, CivilizationsEnum.SENGOKU_DAIMYO, CivilizationsEnum.GOLDEN_HORDE],
        common: true,
        displayOrder: 10100
    },
    SPRINGALD: {
    ...
    MANGONEL: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.HRE, CivilizationsEnum.ENGLAND, CivilizationsEnum.DELHI,
            ...
            CivilizationsEnum.TUGHLAQ_DYNASTY, CivilizationsEnum.SENGOKU_DAIMYO, CivilizationsEnum.MACEDONIAN_DYNASTY,
            CivilizationsEnum.GOLDEN_HORDE],
        common: true,
        displayOrder: 10400
    },
    NEST_OF_BEES: {
    ...
    COUNTERWEIGHT_TREBUCHET: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.HRE, CivilizationsEnum.ENGLAND, CivilizationsEnum.DELHI,
            ...
            CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: true,
        displayOrder: 10700
    },
    BOMBARD: {
        ...
        civilizations: [CivilizationsEnum.ABBASID, CivilizationsEnum.CHINESE, CivilizationsEnum.HRE, CivilizationsEnum.ENGLAND,
            ...
            CivilizationsEnum.SENGOKU_DAIMYO, CivilizationsEnum.MACEDONIAN_DYNASTY, CivilizationsEnum.GOLDEN_HORDE],
        common: true,
        displayOrder: 11000
    },
    IMPERIAL_OFFICIAL: {
    ...
    TRADE_SHIP: {
        ...
        types: [],
        building: Building.DOCK,
        civilizations: allExcept([CivilizationsEnum.GOLDEN_HORDE]),
        common: false,
        displayOrder: 12500
    },
    DHOW: {
    ...
    GALLEY: {
        ...
        civilizations: [CivilizationsEnum.ENGLAND, CivilizationsEnum.FRENCH, CivilizationsEnum.HRE, CivilizationsEnum.RUS,
            ...
            CivilizationsEnum.HOUSE_OF_LANCASTER, CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: false,
        displayOrder: 12700
    },
    JUNK: {
        ...
        civilizations: [CivilizationsEnum.CHINESE, CivilizationsEnum.MONGOLS, CivilizationsEnum.ZHU_XIS_LEGACY, CivilizationsEnum.JAPANESE,
            CivilizationsEnum.SENGOKU_DAIMYO, CivilizationsEnum.GOLDEN_HORDE],
        common: false,
        displayOrder: 12800
    },
    HULK: {
    ...
    DEMOLITION_SHIP: {
        ...
        civilizations: [CivilizationsEnum.OTTOMANS, CivilizationsEnum.MALIANS, CivilizationsEnum.ENGLAND, CivilizationsEnum.FRENCH,
            ...
            CivilizationsEnum.KNIGHTS_TEMPLAR, CivilizationsEnum.HOUSE_OF_LANCASTER, CivilizationsEnum.TUGHLAQ_DYNASTY,
            CivilizationsEnum.MACEDONIAN_DYNASTY, CivilizationsEnum.GOLDEN_HORDE],
        common: false,
        displayOrder: 13400
    },
    EXPLOSIVE_JUNK: {
    ...
    CARRACK: {
        ...
        civilizations: [CivilizationsEnum.OTTOMANS, CivilizationsEnum.ENGLAND, CivilizationsEnum.FRENCH, CivilizationsEnum.HRE,
            ...
            CivilizationsEnum.BYZANTINES, CivilizationsEnum.HOUSE_OF_LANCASTER, CivilizationsEnum.MACEDONIAN_DYNASTY],
        common: false,
        displayOrder: 13600
    },
    BAOCHUAN: {
...
MACEDONIAN_DYNASTY_UNITS.forEach(unit => UNITS.set(unit.id, unit));
GOLDEN_HORDE_UNITS.forEach(unit => UNITS.set(unit.id, unit));
