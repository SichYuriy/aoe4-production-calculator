...
export const IMPROVED_HORTICULTURE_MULTIPLIER = (FERTILIZATION_MULTIPLIER - 1 + 0.025) / 2 * 0.9 + 1;
export const IMPROVED_FERTILIZATION_MULTIPLIER = (CROSS_BREEDING_MULTIPLIER - 1 + 0.025) / 2 * 0.9 + 1;
export const IMPROVED_CROSS_BREEDING_MULTIPLIER = (IMPROVED_FERTILIZATION_MULTIPLIER - 1 + 0.025) * 0.9 + 1;
